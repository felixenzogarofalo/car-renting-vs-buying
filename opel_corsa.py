...
# Especificación
name = "Opel Corsa"
vehicle = VehicleSpec(engine_cc=1199, cylinders=3, power_kw=74, fuel_type='gasoline')
...
finance_new = PurchaseFinanceSpec(
    mode='custom',
    price=23100,
    down_payment=3176.74,
    installment_amount=99,        # monto de la cuota mensual
    installment_count=24,           # número de cuotas
    balloon_final=11709.6          # cuota final
)
...
finance_used = PurchaseFinanceSpec(
    ...
    price=10970,
    down_payment=0.0,
    installment_amount=171,        # monto de la cuota mensual
    installment_count=120,           # número de cuotas
    balloon_final=0.0                # cuota final
)

# Renting
renting_no_upfront = RentingSpec(monthly_fee=250.47, months=36, upfront_fee=0.0,
