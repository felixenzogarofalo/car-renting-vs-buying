...
# Especificación
name = "Dasia Sandero"
vehicle = VehicleSpec(engine_cc=999, cylinders=3, power_kw=67, fuel_type='gasoline')
...
used = UsageSpec(age_years=3, annual_km=10000.0, odometer_km=76593)
    
# Compra nuevo
finance_new = PurchaseFinanceSpec(
    mode='custom',
    price=13940,
    down_payment=2512.75,
    installment_amount=119,        # monto de la cuota mensual
    installment_count=36,           # número de cuotas
    balloon_final=8336.12          # cuota final
)
...
finance_used = PurchaseFinanceSpec(
    ...
    price=11890,
    down_payment=0.0,
    installment_amount=189,        # monto de la cuota mensual
    installment_count=120,           # número de cuotas
    balloon_final=0.0                # cuota final
)

# Renting
renting_no_upfront = RentingSpec(monthly_fee=225, months=72, upfront_fee=0.0,
