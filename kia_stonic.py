...
vehicle = VehicleSpec(engine_cc=999, cylinders=3, power_kw=61, fuel_type='gasoline')
...
finance_new = PurchaseFinanceSpec(
    ...
    balloon_final=13528.38          # cuota final
)
...
finance_used = PurchaseFinanceSpec(
    ...
    price=12190,
    down_payment=0.0,
    installment_amount=190.0,        # monto de la cuota mensual
    installment_count=120,           # número de cuotas
    balloon_final=0.0                # cuota final
)

# Renting
renting_no_upfront = RentingSpec(monthly_fee=323, months=36, upfront_fee=0.0,
...
new_vs_reting = compare_purchase_vs_renting(f"Kia Stonic - Nuevo vs Renting - {years} años", years, vehicle, maint, ins, taxes,
                                            new, finance_new, DepreciationSpec(), renting_no_upfront)

used_vs_reting = compare_purchase_vs_renting(f"Kia Stonic - Usado vs Renting - {years} años", years, vehicle, maint, ins, taxes,
